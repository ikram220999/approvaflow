        ...
        <div className=" sm:w-4/5 m-auto flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="bg-indigo-200 text-gray-700 font-bold px-6 py-2 rounded-md text-center"
            ></input>
            ...
            <Link to={"/home"}>
              <button
                className="text-sm w-full py-2 px-5 border bg-indigo-700 text-white font-bold rounded-lg hover:bg-indigo-600 mt-8"
                //   onClick={""}
              >
                {" "}
                Home
