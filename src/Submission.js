      ...
      <div className="py-10">
        <div className=" sm:w-4/5 m-auto flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <button
              onClick={() => copyId()}
              className=" flex items-center gap-2 py-2 w-full text-center justify-center bg-gray-500 text-white rounded-lg font-semibold hover:bg-gray-400">
              <p className="text-sm sm:text-md">Copy</p>
              <div className="w-4 ">
            ...
            <Link to={"/home"}>
              <button
                className="text-sm sm:text-md w-full py-2 px-5 border bg-indigo-700 text-white font-bold rounded-lg hover:bg-indigo-600 mt-8"
                //   onClick={""}
              >
                {" "}
                Home
